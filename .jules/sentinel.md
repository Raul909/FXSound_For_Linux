...
## 2026-04-29 - [Poisoned Mutex DoS]
**Vulnerability:** Mutex locks using `.unwrap()` on failure could cause permanent Denial of Service (panic) if the mutex becomes poisoned.
