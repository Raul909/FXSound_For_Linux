...
## 2026-05-27 - Prevent IPC Memory Exhaustion DoS
**Vulnerability:** Unvalidated string input from frontend IPC was directly inserted into a dynamically sized HashMap.
**Learning:** Treat all Inter-Process Communication (IPC) command parameters from the frontend as untrusted user input, as malicious actors can spoof these commands to crash the backend.
