...
```bash
wget https://github.com/Raul909/FXSound_For_Linux/releases/latest/download/fxsound-linux_1.1.1_amd64.deb
sudo dpkg -i fxsound-linux_1.1.1_amd64.deb
...
```bash
wget https://github.com/Raul909/FXSound_For_Linux/releases/latest/download/fxsound-linux-1.1.1-1.x86_64.rpm
sudo rpm -i fxsound-linux-1.1.1-1.x86_64.rpm
```
