...
```bash
wget https://github.com/Raul909/FXSound_For_Linux/releases/latest/download/fxsound-linux_1.0.3_amd64.AppImage
chmod +x fxsound-linux_1.0.3_amd64.AppImage
...
```bash
wget https://github.com/Raul909/FXSound_For_Linux/releases/latest/download/fxsound-linux_1.0.3_amd64.deb
sudo dpkg -i fxsound-linux_1.0.3_amd64.deb
...
```bash
wget https://github.com/Raul909/FXSound_For_Linux/releases/latest/download/fxsound-linux-1.0.3-1.x86_64.rpm
sudo rpm -i fxsound-linux-1.0.3-1.x86_64.rpm
```
