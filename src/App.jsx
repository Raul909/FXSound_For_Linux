      ...
      <div className="app-window">
        ...
        <div className="header">
          <div className="header__left">
            ...
            >
              <svg width="22" height="22" viewBox="0 0 24 24" fill={powered ? "#fff" : "#555"} aria-hidden="true">
            ...
            {dropdowns.map(({ label, value: val, options, onChange, showCustom }) => (
              <div key={label} className="dropdown">
                ...
                <div className="dropdown__wrapper">
                  ...
                  <svg className="dropdown__arrow" width="10" height="6" viewBox="0 0 10 6" aria-hidden="true">
