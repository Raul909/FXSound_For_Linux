        ...
        <div className="header">
          <div className="header__left">
            <button
              ...
              aria-label={powered ? "Turn off FXSound" : "Turn on FXSound"}
              title={powered ? "Turn off FXSound" : "Turn on FXSound"}
            >
          ...
          <div className="header__dropdowns">
            {dropdowns.map(({ label, value: val, options, onChange, showCustom }) => (
              <div key={label} className="dropdown">
                <label className="dropdown__label" id={`dropdown-label-${label.replace(/\s+/g, "-").toLowerCase()}`}>{label}</label>
                <div className="dropdown__wrapper">
                  <select
                    ...
                    aria-labelledby={`dropdown-label-${label.replace(/\s+/g, "-").toLowerCase()}`}
                  >
                    {options.map((opt) => (
