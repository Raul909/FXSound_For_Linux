...
const EQBand = memo(function EQBand({ freq, value, onChange, disabled }) {
    ...
    // Convert a mouse Y position to a gain value (-12 to +12 dB) using a cached bounding rect
    ...
    function handleMouseDown(event) {
        ...
        // Cache the bounding rect once on mouse down to prevent layout thrashing on mouse move
