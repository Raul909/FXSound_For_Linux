    ...
    return (
        <div className="eq-band">
            ...
            <div
                ...
                onKeyDown={(e) => {
                    if (disabled) return;
                    if (e.key === "ArrowUp" || e.key === "ArrowRight") onChange(Math.min(12, value + 1));
                    if (e.key === "ArrowDown" || e.key === "ArrowLeft") onChange(Math.max(-12, value - 1));
                    if (e.key === "Home") onChange(-12);
                    if (e.key === "End") onChange(12);
                }}
