    ...
    return (
        <div className="eq-band">
            ...
            <div
                ...
                onKeyDown={(e) => {
                    if (disabled) return;
                    if (e.key === "ArrowRight" || e.key === "ArrowUp") { e.preventDefault(); onChange(Math.min(12, value + 1)); }
                    else if (e.key === "ArrowLeft" || e.key === "ArrowDown") { e.preventDefault(); onChange(Math.max(-12, value - 1)); }
                    else if (e.key === "Home") { e.preventDefault(); onChange(-12); }
                    else if (e.key === "End") { e.preventDefault(); onChange(12); }
                }}
