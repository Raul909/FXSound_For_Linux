    ...
    useEffect(() => {
        ...
        async function init() {
            ...
            if (backendOk && !cancelled) {
                ...
                // Using recursive setTimeout instead of setInterval to prevent overlapping invoke calls and performance degradation
                const pollBackend = async () => {
                    ...
                    if (!cancelled) pollTimeout = setTimeout(pollBackend, 50);
                };
            ...
            if (!cancelled) {
                ...
                let phase = 0;
                // Using recursive setTimeout instead of setInterval to prevent overlapping calls and performance degradation
                const pollIdle = () => {
                    phase += 0.08;
                    ...
                    if (!cancelled) pollTimeout = setTimeout(pollIdle, 50);
                };
